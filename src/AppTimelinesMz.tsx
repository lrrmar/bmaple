...
import MozambiqueLocationsSource from './modules/fasta/MozambiqueLocationsSource';
...
const AppTimelines = () => {
  ...
  const [domain, setDomain] = useState<string>("Mozambique");
  const [token, setToken] = useState<string>("");

  useEffect(() => {
    // note API token is country specific
    setToken('PqdOt2wKphApERBTMv2nH8-aVHDJFSb0cdPCWaFM004');
  }, [domain]);
  ...
  return (
      ...
      <Map>
        ...
        <Sources>
          ...
          <MozambiqueLocationsSource  sourceIdentifier={'waypoint'} />
          </Sources>
        <BaseMaps>
          <DarkBaseMap id={'dark'} />
