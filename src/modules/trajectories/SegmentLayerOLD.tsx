...
interface Segment extends Pending {
  longitude: number;
  latitude: number;
  time: string;
...
export const isSegment = (element: any): element is Segment => {
...
const SegmentSourceLayer = ({ id, sourceIdentifier }: Props) => {
...
export default SegmentSourceLayer;
